      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2">
        ...
        <li *ngFor="let breadcrumb of breadcrumbs; let first = first; let last = last">
          <div class="flex items-center">
            <i *ngIf="!first" class="fas fa-chevron-right text-gray-400 text-xs mx-1"></i>
            ...
            <a *ngIf="!last" [routerLink]="breadcrumb.url" 
               ...
               <i *ngIf="first" class="fas fa-home mr-2"></i>
              {{ breadcrumb.label | translate }}
            </a>
            
            <span *ngIf="last" class="inline-flex items-center text-sm font-medium text-gray-900" aria-current="page">
               <i *ngIf="first" class="fas fa-home mr-2"></i>
              {{ breadcrumb.label | translate }}
            </span>
          </div>
